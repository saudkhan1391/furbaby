...
const CarouselTwo = () => {
    ...
    <div class="carousel-inner">
        <input class="carousel-open hidden" type="radio" id="carousel-4" name="carouselTwo" aria-hidden="true" hidden="" checked="checked" />
...
<span class="normal"> Day 2/2</span>
        ...
        <input class="carousel-open hidden" type="radio" id="carousel-5" name="carouselTwo" aria-hidden="true" hidden="" />
        <div class="carousel-item">
        <div class="flex mt-12 justify-center mb-12">
...
<span class="normal"> Day 2/2</span>
        ...
        <label for="carousel-5" class="carousel-control next control-4"><img src={require('../../assets/images/sl-next.png')} alt="pic" /></label>
        <label for="carousel-5" class="carousel-control prev control-4"><img src={require('../../assets/images/sl-prev.png')} alt="pic" /></label>
        {/*<label for="carousel-3" class="carousel-control next control-2"><img src={require('../../assets/images/sl-next.png')} alt="pic" /></label>*/}
        <label for="carousel-4" class="carousel-control prev control-5"><img src={require('../../assets/images/sl-prev.png')} alt="pic" /></label>
        <label for="carousel-4" class="carousel-control next control-5"><img src={require('../../assets/images/sl-next.png')} alt="pic" /></label>
